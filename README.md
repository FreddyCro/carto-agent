...
以一個 React Todo App 走完閉環流程（初始化 → Tier 1 修 bug → Tier 2 新功能 → 知識回流）。

> 完整 walkthrough：[docs/examples/todo-app-walkthrough.md](docs/examples/todo-app-walkthrough.md)
...
CartoAgent 的設計受到以下概念啟發：

- **[C4 Model](https://c4model.com/)** — 架構視圖分層（L3 Component / L4 Infrastructure）
- **[GitHub Spec Kit](https://github.com/github/spec-kit)** — Spec-Driven Development：先定義規格再實作
- **[ADR](https://adr.github.io/)** — 架構決策記錄的標準化格式（Michael Nygard）
- **[xyflow](https://xyflow.com/)** — Node-Edge 抽象與流程視覺化
